...
router.route("/product").get(authenticateUserJWT,(req,res)=>productController.getAll(req,res));
router.route("/product/:id").get(authenticateUserJWT,(req,res)=>productController.get(req,res));
